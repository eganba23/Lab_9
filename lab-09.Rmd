...
The regression equation should be y = 4.09 + .142x, where y is score and x = gender.
...
The regression equation should be y = 4.28 - .130x, where y is score and x = gender.
